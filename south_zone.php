...
<i><h2 id="south"><blink>WELCOME TO SOUTH ZONE</blink></h2></i>
...
if(isset($_POST['submit']))
{
	...
	if(!empty($unique_id))
	{
		...
		elseif((($unique_id <= $row2['lastrange1'])&&($unique_id > $row2['startrange1']))||(($unique_id <= $row2['lastrange2'])&&($unique_id > $row2['startrange2']))||(($unique_id <= $row2['lastrange3'])&&($unique_id > $row2['startrange3']))||(($unique_id <= $row2['lastrange4'])&&($unique_id > $row2['startrange4'])))
